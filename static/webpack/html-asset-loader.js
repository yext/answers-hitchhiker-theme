 ...
 * This references the static directory webpack alias.
 * 
 * In the browser, these usages will be changed to something that looks like
 * "/my-special-image.abcd1234.svg", where abcd1234 is the hash of this particular asset.
 * 
...
module.exports = function loader(source) {
  ...
  source = source.replace(regex, function(match, group1) {
    ...
    const staticAssetPath = group1.substring(group1.indexOf('static/'));
    const importString =
