...
module.exports = function () {
  ...
  const commonConfig = {
    ...
    entry: {
      ...
      'iframe-dynamic': `./${jamboConfig.dirs.output}/static/js/iframe-dynamic.js`,
      'iframe-dynamic-prod': `./${jamboConfig.dirs.output}/static/js/iframe-dynamic-prod.js`,
      'iframe-dynamic-staging': `./${jamboConfig.dirs.output}/static/js/iframe-dynamic-staging.js`,
