import { DayNames, TableHeaders } from './hours/constants.js';
 ...
 * @param {string} locale
 */
export function provideOpenStatusTranslation (locale) {
...
export function provideTableHeadersTranslation(locale) {
  const language = locale.substring(0,2);
  switch (language) {
    case 'fr':
      return {
