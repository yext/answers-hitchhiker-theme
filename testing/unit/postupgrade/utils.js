...
describe('postupgrade utils', () => {
  describe('mergeJson', () => {
    it('puts together two comment JSON strings', () => {
      const config1 = fs.readFileSync('./testing/unit/postupgrade/config1.json', 'utf-8');
      const config2 = fs.readFileSync('./testing/unit/postupgrade/config2.json', 'utf-8');
      const expected = fs.readFileSync('./testing/unit/postupgrade/config3.json', 'utf-8');
