{{> cards/card_component componentName='multilang-financial-professional-location' }}

class multilang_financial_professional_locationCardComponent extends BaseCard['multilang-financial-professional-location'] {
  ...
  static defaultTemplateName (config) {
    return 'cards/multilang-financial-professional-location';
  }
}

ANSWERS.registerTemplate(
  'cards/multilang-financial-professional-location',
  {{{stringifyPartial (read 'cards/multilang-financial-professional-location/template') }}}
);
